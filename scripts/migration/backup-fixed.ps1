# Fixed Backup Script for Mereka Automation Project
...
# Copy files excluding large directories and backup directories
$excludePatterns = @("node_modules", ".git", "test-results", "playwright-report", "backup-*")

Get-ChildItem -Path "." | Where-Object { 
    $_.Name -notin $excludePatterns -and $_.Name -notlike "backup-*"
} | ForEach-Object {
